...
public class Text1Adapter extends DelegateAdapter.Adapter<Text1Adapter.HomeHolder> {
    private SingleLayoutHelper singleLayoutHelper;
    private Context context;

    public Text1Adapter(SingleLayoutHelper singleLayoutHelper, Context context) {
